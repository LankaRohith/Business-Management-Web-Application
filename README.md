...
![home (2)](https://github.com/LankaRohith/Business-Management-Web-Application.git)
...
1. Clone the repository : $ git clone https://github.com/LankaRohith/Business-Management-Web-Application.git <br>
